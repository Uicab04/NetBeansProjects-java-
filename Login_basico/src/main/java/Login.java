...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Login Zapateria"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(usuario.isEmpty() || paswd.isEmpty()){
           JOptionPane.showMessageDialog(null, "Algun campo está vacio");
        
        }else{ 
            if(usuario.equals("victor") && paswd.equals("uicab") ) {
                JOptionPane.showMessageDialog (null, "Bienvenido");
                panel_basico pc =  new panel_basico();
                pc.setVisible(true); 
                this.dispose();
